...
mod tests {
    ...
    fn test_create_block() -> Result<(), Box<dyn Error>> {
        ...
        let block = BlockService::create(&mut adapter, &page_id, None, "Test content", "{}", "bullet")?;
    ...
    fn test_get_block_by_id() -> Result<(), Box<dyn Error>> {
        ...
        let created = BlockService::create(&mut adapter, &page_id, None, "Content", "{}", "bullet")?;
    ...
    fn test_update_block() -> Result<(), Box<dyn Error>> {
        ...
        let mut block = BlockService::create(&mut adapter, &page_id, None, "Old content", "{}", "bullet")?;
    ...
    fn test_delete_block() -> Result<(), Box<dyn Error>> {
        ...
        let block = BlockService::create(&mut adapter, &page_id, None, "Content to delete", "{}", "bullet")?;
    ...
    fn test_build_tree() -> Result<(), Box<dyn Error>> {
        ...
        let root1 = BlockService::create(&mut adapter, &page_id, None, "Root 1", "{}", "bullet")?;
        let root2 = BlockService::create(&mut adapter, &page_id, None, "Root 2", "{}", "bullet")?;
        let child1 = BlockService::create(&mut adapter, &page_id, Some(&root1.id), "Child 1", "{}", "bullet")?;
    ...
    fn test_gap_sort_pos() -> Result<(), Box<dyn Error>> {
        ...
        let first = BlockService::create(&mut adapter, &page_id, None, "First", "{}", "bullet")?;
        assert_eq!(first.pos, 1000);

        let second = BlockService::create(&mut adapter, &page_id, None, "Second", "{}", "bullet")?;
        assert_eq!(second.pos, 500);

        let third = BlockService::create(&mut adapter, &page_id, None, "Third", "{}", "bullet")?;
